...
&end
EOF
mpirun -map-by numa -bind-to numa  ./kshell.exe V50_gxpf1a_0.input > log_V50_gxpf1a_m0p.txt  
...
&end
EOF
mpirun -map-by numa -bind-to numa  ./transit.exe V50_gxpf1a_0_0.input > log_V50_gxpf1a_tr_m0p_m0p.txt  
