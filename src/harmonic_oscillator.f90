...
!
  ...
  implicit none
  real(8), protected :: hbar_omega = 0.d0,  bpar = 1.0d0
  private
  public :: hbar_omega, init_ho_by_mass, init_ho_by_hw, init_ho_by_b, &
       radius_power, radius_j, nabla_j
...
! direct integral should be done instead
     ...
     write(*,'(1a,1i3,2x,1a,1i3,2x,1a,1i3)') 'l1 =', l1, 'l2 =', l2, 'k =', k
     stop
  end if
...
function radius_j(n1, l1, j1, n2, l2, j2) result (r)
  ...
  ! it sould be replaced by radius_power
  integer, intent(in) :: n1, l1, j1, n2, l2, j2
  real(8) :: r
