...
thrd_e2 = 1.0   # 10.0  # threshold for B(E2) to appear in summary
thrd_m1 =  0.01 # 0.05  # threshold for B(M1) to appear in summary
...
def read_file_tran(fn, asc, thrd):
    ...
    while True:
        ...
        while True:
            ...
            if ex > 0.0:
                out += "%3d%c(%4d) %7.3f %3d%c(%4d) %7.3f %7.3f %10.2f %10.2f\n" \
